    ...
    <div class="modal-content">
      ...
      <div class="alert alert-warning" role="alert">
        ...
        <form action="/Bootstrap/hh.php" class="form cytech-form">
          ...
          <select class="form-select select-option-change" data-link="core/utilities/Maquinas/cargar_modelos_select.php" name="id_proveedor" id="id_proveedor_select" required>
          ...
          <select class="form-select select-option-load" name="id_modelo" id="id_modelo_select" required>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <blockquote class="blockquote mb-0">
            <table id="tablaMisMaquinas" data-link="core/utilities/Maquinas/TablaMisMaquinas.php" class="table table-striped table-hover">
                <thead>
                  <tr>
                    <th>UID</th>
                    <th>Modelo</th>
